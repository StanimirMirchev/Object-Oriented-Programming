...
namespace Student
{
    class MainProgram
    {
        static void Main(string[] args)
        {
            ...
            Student student1 = new Student("Petq", "Georgieva", 35, 44563,
                "08097654321", "petq@abv.bg",marks1, 2);

            List<int> marks2 = new List<int>() { 2, 5, 6 };
            Student student2 = new Student("Ivailo", "Vasilev", 20, 44654,
                "08097654321", "ivailo@abv.bg", marks2, 3);

            List<int> marks3 = new List<int>() {6,6,6};
            Student student3 = new Student("Georgi", "Georgiev", 22, 44655,
                "08097654321", "georgi@abv.bg", marks3, 2);

            List<int> marks4 = new List<int>() { 2, 2};
            Student student4 = new Student("Marin", "Karakachanov", 22, 44656,
                "08097654321", "marin@abv.bg", marks3, 2);
